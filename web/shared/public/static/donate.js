(function (t) {
  ...
  function s(i) {
    ...
    t[i].call(l.exports, l, l.exports, s);
    l.l = true;
    return l.exports;
  }
  s.m = t;
  ...
  window.addEventListener("DOMContentLoaded", function () {
    ...
    e.innerHTML = "<img src=\"https://cdn.buymeacoffee.com/widget/assets/coffee%20cup.svg\" alt=\"Buy Me A Coffee\" style=\"height: 25px; width: 25px; margin: 0; padding: 0;\">";
    e.style.zIndex = "9999";
    ...
    if (t.matches) {
      ...
      a.style.bottom = parseInt(s.dataset.y_margin, 10) + 43 + "px";
    } else {
      a.style.left = "0px";
      a.style.right = "0px";
      a.style.top = "0px";
    ...
    e.onclick = function () {
      // if (!r) {
      a.src = "https://www.buymeacoffee.com/widget/page/" + s.dataset.id + "?description=" + encodeURIComponent(s.dataset.description) + "&color=" + encodeURIComponent(s.dataset.color);
      // }
      // r++;
      o.style.transform = "scale(0.7)";
      o.style.opacity = "0";
    ...
    if (y.includes("visited") || s.dataset.message == "") {
      o.style.transform = "scale(0.7)";
      o.style.opacity = "0";
      o.style.transition = ".25s ease all";
      o.style.visibility = "hidden";
